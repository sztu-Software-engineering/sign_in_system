# Generated by Django 4.2.8 on 2023-12-28 08:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('studentid', models.ForeignKey(db_column='StudentID', on_delete=django.db.models.deletion.DO_NOTHING, to='common.student')),
            ],
            options={
                'db_table': 'SignMsg',
                'managed': True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('courseid', models.OneToOneField(db_column='CourseID', on_delete=django.db.models.deletion.DO_NOTHING, to='common.course')),
                ('studentid', models.ForeignKey(db_column='StudentID', on_delete=django.db.models.deletion.DO_NOTHING, to='common.student')),
            ],
            options={
